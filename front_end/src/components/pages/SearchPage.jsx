...
class SearchPage extends StateSwitchComponent{
  constructor(props){
    super(props);
    ...
    this.state = {
      name:'Player Name',
      position: this.mainSiteComponent.state.originalStateInfo.position || 'QB',
  ...
  render() {
    ...
    return (
      <div>
      <Box sx={{p: 2, m:2}} flexGrow =" 1"  justifyContent="center" textAlign= "center">
      ...
      Use The Sliders to Determine the Multiplier of Each Trait. Blank Traits Will Be Given a Multiplier of 0 Automatically.
         ...
         <Box
          ...
          <FormControl>
          <Select
               defaultValue = {this.mainSiteComponent.state.originalStateInfo.position ? this.mainSiteComponent.state.originalStateInfo.position : "QB"}
               autoWidth
        ...
        <FormControl>
          ...
          <Slider defaultValue={this.mainSiteComponent.state.originalStateInfo.year || 2000} min={1987} max={2024} valueLabelDisplay="on"
